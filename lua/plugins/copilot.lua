return {
		...
		config = function()
			require("copilot").setup({
				suggestion = {
					...
					auto_trigger = true, -- If `true`, Copilot will suggest automatically
				...
				panel = {
					enabled = true, -- Enables the multiple suggestions panel
					auto_refresh = true,
					keymap = {
	...
	},
	{
		...
		after = "copilot.lua", -- Ensure the core plugin is loaded first
		config = function()
			require("copilot_cmp").setup({
				method = "getCompletionsCycling", -- Efficient cycling of suggestions
			})
		end,
	},
}
